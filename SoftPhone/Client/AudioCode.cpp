...
// extern "C"
// {
// #include "../inc/G7231/typedef.h"
// #include "../inc/G7231/cst_lbc.h"
// #include "../inc/G7231/decod.h"
// #include "../inc/G7231/coder.h"
// }
...
BOOL CAudioCodeG729::EncodeAudioData(char *pin,int len,char* pout,int* lenr)
{
	BOOL bRet=FALSE;
...
BOOL CAudioCodeG729::DecodeAudioData(char *pin,int len,char* pout,int* lenr)
{
	BOOL bRet=FALSE;
	if(!pin||len!=SIZE_AUDIOG729_PACKED||!pout)
		goto RET;
...
CAudioCodeG7231::CAudioCodeG7231()
{
}
CAudioCodeG7231::~CAudioCodeG7231()
{
...
BOOL CAudioCodeG7231::EncodeAudioData(char *pin,int len,char* pout,int* lenr)
{
		BOOL bRet=FALSE;
	if(!pin||len!=SIZE_AUDIO_FRAME||!pout)
		goto RET;
...
BOOL CAudioCodeG7231::DecodeAudioData(char *pin,int len,char* pout,int* lenr)
{
	BOOL bRet=FALSE;
	if(!pin||len!=SIZE_AUDIOG729_PACKED||!pout)
		goto RET;
